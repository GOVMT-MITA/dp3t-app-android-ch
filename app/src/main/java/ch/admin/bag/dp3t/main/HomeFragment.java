...
public class HomeFragment extends Fragment {
        ...
        toolbar.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.homescreen_menu_language_selection:
                    ...
                    return true;
                case R.id.homescreen_menu_about:
                    HtmlFragment htmlFragment = HtmlFragment.newInstance(R.string.menu_about, AssetUtil.getAboutBaseUrl(getContext()), AssetUtil.getAboutHtml(getContext()));
    ...
    private void setupInformationView() {
        ...
        informationCard.setOnClickListener(v -> openLink(R.string.information_url));
    }
...
//        requireView().findViewById(R.id.main_button_debug).setOnClickListener(v -> {
