...
public class NotificationUtil {
	...
	public static final int NOTIFICATION_ID_INTEROP_AVAILABLE = 44;
	public static final int NOTIFICATION_ID_INTEROP_UNAVAILABLE = 45;
	public static final int NOTIFICATION_ID_INTEROP_COUNTRIES_CHANGED = 46;
